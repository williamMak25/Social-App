...
export const Chat = () => {
  ...
  return (
    ...
    <NavLink to='/' className='text-4xl w-80 text-end max-[395px]:hidden'><i className="bi bi-x text-white"></i></NavLink>
        ...
        <div className='flex flex-row items-center justify-start bg-white w-80 px-2 py-1 rounded-t drop-shadow mt-1 max-[395px]:w-screen max-[395px]:h-16 max-[395px]:sticky top-0'>
          ...
          <div className='messages-container flex flex-column justify-end overflow-y-auto w-80 bg-slate-400 max-[395px]:w-screen max-[395px]:h-screen'> 
  ...
  <div className='bg-white w-80 flex flex-row rounded-b max-[395px]:w-screen max-[395px]:1/5 max-[395px]:sticky bottom-0'>
    <input type='text'
           value={message}
